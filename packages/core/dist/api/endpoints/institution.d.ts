...
import type { Institution, InstitutionPublicInfo, Department, CreateDepartmentRequest, UpdateDepartmentRequest, LabDepartmentRequest, InstitutionMembership, InstitutionMemberInfo, InstitutionRole, InstitutionPermissionsByResource, AllowedCollaboration, InstitutionCollaborationRequest, InstitutionCollaborationActionRequest, InstitutionLabInfo, CollaborationHistoryResponse, InstitutionOrderRequestsParams, InstitutionOrderRequestsResponse, InstitutionInventoryParams, InstitutionInventoryResponse, InstitutionInvitationDetails, CreateInstitutionRoleRequest, UpdateInstitutionRoleRequest, DeleteInstitutionRoleRequest, PlaceInstitutionOrderRequest, PlaceInstitutionOrderResponse, RevertInstitutionOrderRequest, UpdateInstitutionProfileRequest, InstitutionDirectoryResponse } from '../../types/institution';
/**
