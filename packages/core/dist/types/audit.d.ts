 ...
 */
export type AuditResourceType = 'INVENTORY' | 'ORDER_REQUEST' | 'GRANT' | 'TAG' | 'PROFILE' | 'LAB' | 'MEMBERSHIP' | 'INVITATION' | 'RESERVATION' | 'MACHINE' | 'TOOL' | 'TOOL_CHECKOUT' | 'INVOICE' | 'AUDIT_LOG';
/**
 ...
 */
export declare const AUDIT_EVENT_LABELS: Record<AuditEventType, string>;
/**
 * Constants for resource type display
 */
export declare const AUDIT_RESOURCE_LABELS: Record<AuditResourceType, string>;
/**
 * Default retention period in years (for HIPAA compliance)
 */
export declare const AUDIT_RETENTION_YEARS = 7;
